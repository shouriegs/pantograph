...
{
    class LetterClass4 : LetterClass
    {
        //any variables specific to this letter

        public LetterClass4(VectorClass _origin)
        {
            origin = _origin;
            PopulateCurvesList();
        }
        ...
        public override void PopulateCurvesList()
        {
            ...
            VectorClass _point1 = VectorClass.ScalarMultiply(new VectorClass(0.7, 1), _fontSize);
            VectorClass _point2 = VectorClass.ScalarMultiply(new VectorClass(0, 0.4), _fontSize);
            VectorClass _point3 = VectorClass.ScalarMultiply(new VectorClass(1, 0.4), _fontSize);
            VectorClass _point4 = VectorClass.ScalarMultiply(new VectorClass(0.7, 0), _fontSize);
            ...
            StraightLine _line3 = new StraightLine(_point3, _point1, false);
            StraightLine _line4 = new StraightLine(_point1, _point4, true);
