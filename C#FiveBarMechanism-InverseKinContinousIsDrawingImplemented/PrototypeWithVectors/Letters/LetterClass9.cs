...
{
    class LetterClass9 : LetterClass
    {
        //any variables specific to this letter

        public LetterClass9(VectorClass _origin)
        {
            origin = _origin;
            PopulateCurvesList();
        }
        ...
        public override void PopulateCurvesList()
        {
            ...
            VectorClass _point2 = VectorClass.ScalarMultiply(new VectorClass(0.5, 0.75), _fontSize);
            ...
            CircularArc _arc1 = new CircularArc(_point1, 0.25 * _fontSize, 0, 360, true, true);
            StraightLine _line1 = new StraightLine(_point2, _point3, true);
            CircularArc _arc2 = new CircularArc(_point4, 0.25 * _fontSize, 0, -180, false, true);
