...
{
    public class LetterClassA : LetterClass
    {
        //any variables specific to this letter

        public LetterClassA(VectorClass _origin)
        {
            origin = _origin;
            PopulateCurvesList();
        }
        ...
        public override void PopulateCurvesList()
        {
            ...
            VectorClass _point4 = VectorClass.ScalarMultiply(new VectorClass(0.25, 0), _fontSize);
            VectorClass _point5 = VectorClass.ScalarMultiply(new VectorClass(0.25, 0.4), _fontSize);
            VectorClass _point6 = VectorClass.ScalarMultiply(new VectorClass(0.75, 0.4), _fontSize);
            ...
            StraightLine _line3 = new StraightLine(_point3, _point4, false);
