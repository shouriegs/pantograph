...
{
    class LetterClassJ : LetterClass
    {
        //any variables specific to this letter

        public LetterClassJ(VectorClass _origin)
        {
            origin = _origin;
            PopulateCurvesList();
        }
        ...
        public override void PopulateCurvesList()
        {
            ...
            VectorClass _point3 = VectorClass.ScalarMultiply(new VectorClass(0.25, 0.25), _fontSize);
            VectorClass _point4 = VectorClass.ScalarMultiply(new VectorClass(0, 0.25), _fontSize);
            VectorClass _point5 = VectorClass.ScalarMultiply(new VectorClass(0, 1), _fontSize);
            VectorClass _point6 = VectorClass.ScalarMultiply(new VectorClass(1, 1), _fontSize);
            ...
            CircularArc _arc1 = new CircularArc(_point3, 0.25 * _fontSize, 0, -180, false, true);
            StraightLine _line2 = new StraightLine(_point4, _point5, false);
            StraightLine _line3 = new StraightLine(_point5, _point6, true);
