...
{
    class LetterClassK : LetterClass
    {
        //any variables specific to this letter

        public LetterClassK(VectorClass _origin)
        {
            origin = _origin;
            PopulateCurvesList();
        }
        ...
        public override void PopulateCurvesList()
        {
            ...
            VectorClass _point3 = VectorClass.ScalarMultiply(new VectorClass(0, 0.5), _fontSize);
            VectorClass _point4 = VectorClass.ScalarMultiply(new VectorClass(0.5, 1), _fontSize);
            VectorClass _point5 = VectorClass.ScalarMultiply(new VectorClass(0.5, 0), _fontSize);
            ...
            StraightLine _line4 = new StraightLine(_point4, _point3, true);
            StraightLine _line5 = new StraightLine(_point3, _point5, true);
