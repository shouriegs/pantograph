...
{
    public class LetterClassR : LetterClass
    {
        public LetterClassR(VectorClass _origin)
        {
            origin = _origin;
            PopulateCurvesList();
        }
        ...
        public override void PopulateCurvesList()
        {
            ...
            VectorClass _point6 = VectorClass.ScalarMultiply(new VectorClass(0.75, 0), _fontSize);
