...
{
    class LetterClassW : LetterClass
    {
        //any variables specific to this letter

        public LetterClassW(VectorClass _origin)
        {
            origin = _origin;
            PopulateCurvesList();
        }
        ...
        public override void PopulateCurvesList()
        {
            ...
            VectorClass _point4 = VectorClass.ScalarMultiply(new VectorClass(0.9, 0), _fontSize);
            VectorClass _point5 = VectorClass.ScalarMultiply(new VectorClass(1.2, 1), _fontSize);
