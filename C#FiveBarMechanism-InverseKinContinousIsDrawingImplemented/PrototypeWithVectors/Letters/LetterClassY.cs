...
{
    class LetterClassY : LetterClass
    {
        //any variables specific to this letter

        public LetterClassY(VectorClass _origin)
        {
            origin = _origin;
            PopulateCurvesList();
        }
        ...
        public override void PopulateCurvesList()
        {
            ...
            VectorClass _point2 = VectorClass.ScalarMultiply(new VectorClass(0.5, 0.5), _fontSize);
            VectorClass _point3 = VectorClass.ScalarMultiply(new VectorClass(1, 1), _fontSize);
            VectorClass _point4 = VectorClass.ScalarMultiply(new VectorClass(0, 0), _fontSize);
